# -*- coding: utf-8 -*-
"""
Telegram Bot для сбора заявок - FirstVDS версия
"""
import sys
import asyncio
import time
...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    try:
        ...
        if step == "waiting_name":
            ...
            await update.message.reply_text(
                "KAIF! Ждите звонка, "
                "в скором времени свяжемся с вами. Если хотите что-то дополнить или исправить, просто напишите снизу дополнительную информацию, которую нам надо знать. "
            )
